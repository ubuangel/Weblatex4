 ...
 *           n es el número de términos de la serie de Maclaurin a utilizar
 *           n debe ser divisible por el número de subprocesos
 * 
 * Input:    none      
 *      
 * Output:  : La estimación de pi usando múltiples subprocesos, un subproceso y el valor calculado 
 * por la función arctan de la biblioteca matemátic   a.
 * También los tiempos transcurridos para los cálculos de subprocesos múltiples y de un solo subproceso
 *
 * Notes:
